    ...
    with sql_engine.connect() as conn:
        ...
        def _parse_data(data):
            ...
            for u in soup.find_all('b'):
                ...
                counter_3+=1
        conn.execute(sa.text(f'''drop table "ODS_TIMETABLE".ods_timetable_act;
        CREATE TABLE "ODS_TIMETABLE".ods_timetable_act (url varchar(256) NULL, group_text text NULL, time_interval_text text NULL, event_text text NULL);'''))
